  ...
  return (
    <SafeAreaView style={styles.root}>
        ...
        <View style={styles.showStops}>
           { stops.length === 0 ? <Text style={styles.showStopsTitle}>
                aún no has elegido ninguna parada 
            </Text>: <View>{stops.map((item,index)=><ItemStops  key={index} index={index+1} item={item} />)}</View> 
        ...
        <CustomButton textButton="LIMPIAR DE EL MAPA" typeButton="terseary"
            typeText="secondary" />
            </View>
        </View>
    </SafeAreaView>
